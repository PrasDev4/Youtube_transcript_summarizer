...
def result():
    if request.method == 'POST':
        ...
        try:
            ...
            # Save the summary and transcript to files with UTF-8 encoding
            with open('static/summary.txt', 'w', encoding='utf-8') as file:
                file.write(summary)
            
            with open('static/transcript.txt', 'w', encoding='utf-8') as file:
        ...
        try:
            with open('static/summary.txt', 'r', encoding='utf-8') as file:
                summary = file.read()
            return render_template('result.html', summary=summary)
        except Exception as e:
            return str(e)
...
def transcript():
    try:
        with open('static/transcript.txt', 'r', encoding='utf-8') as file:
